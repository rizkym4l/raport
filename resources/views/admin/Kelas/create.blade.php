        ...
        <div class="container mx-auto space-y-6">
                ...
                <div class="flex items-center gap-4">
                    ...
                    <div>
                        <h1
                            ...
                            {{ isset($kelas) ? 'Edit Class' : 'Add New Class' }}
                        </h1>
                        <p class="text-slate-400">{{ isset($kelas) ? 'Update class information' : 'Create a new class' }}
                        </p>
                    </div>
                </div>
            </div>
            ...
            <div class="bg-slate-800/50 backdrop-blur-xl border border-slate-700 rounded-xl shadow-xl overflow-hidden">
                <div class="p-6 border-b border-slate-700">
                    <h2 class="text-lg font-semibold text-white">Class Details</h2>
                </div>
                ...
                <form action="{{ isset($kelas) ? route('kelas.update', $kelas->id) : route('kelas.store') }}" method="POST"
                    ...
                    <div class="space-y-2">
                        <label for="nama_kelas" class="block text-sm font-medium text-slate-300">Class Name</label>
                    ...
                    <div class="space-y-2">
                        <label for="tingkat" class="block text-sm font-medium text-slate-300">Grade Level</label>
                    ...
                    <div class="flex justify-end space-x-3">
                        ...
                        <button type="submit"
                            ...
                            {{ isset($kelas) ? 'Update Class' : 'Add Class' }}
                        </button>
                    </div>
                </form>
            </div>
